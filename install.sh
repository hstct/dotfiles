...
# ui
pacstrap -i /mnt sway swaylock xorg-server-xwayland wl-clipboard python-i3ipc mako gtk-theme-arc-gruvbox-git wlsunset waybar light slurp wluma vulkan-intel vulkan-headers flashfocus-git qt5-wayland wtype wlrctl wldash swayr wofi
